...
cl = LINETCR.LINE()
cl.login(token="Ep8fkPvLbhf3NsPNDjk6.+oHJ9I9aCgWb/KO8peYWLG.doQWTUorPMWj1LZ0VfIkWk0MMlxPFc0MKTUUZqllA/4=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EpCL4HUR9Ixd49e0zvFc.qN2zpFaxEm1o31ZyW+asRa.6+wkpya3tP/3YcAScmqS44ruzmN2/0L7HlLq+8XdJPI=")
ki.loginResult()

ki2= LINETCR.LINE()
ki2.login(token="Ep9vnPE2a6nanCGjbIlb.9iA5YOO+Gh+pvoTLX5MtAW.jHAHaA6tZiMYtuF6rRjCPGd2mw6wggk5oTug9XGDK40=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EpwVJdLSmdmynfhAf1La.eN9etnjnxZHlipRS8kIocG.88oAZM50KoJlto0y24wYeztvAIwp2woILM2mECx7nKE=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="EpBAwss0yxCjJbKzB3gd.gcrtpjX9ttG/3GuSnu91hq.08kQuYYqJczaKRmSjNigE1cW6KZ66YUpzfsgR/Oqnvk=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="Ep3sUzHjZqsbLTVMvoaf.bdJc2CtPR2TSv5gphRuypW.kQnjiDiYsI6GWXl/9ff+CzHmxJ8BbElQIB4Wj98oFeo=")
ki5.loginResult()
...
#                if msg.from_ in admin:
			...
			elif "Tts " in msg.text:
            	  if wait["media"] == True:
						songname = msg.text.replace("Tts ","")
